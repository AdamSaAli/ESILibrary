...
def findColdestDays():
    ...
    # Find the two coldest days
    coldest_days = df.nsmallest(2, 'Temp')

    # Create a PyDeck map
    view_state = pdk.ViewState(
        latitude=coldest_days['Latitude'].mean(),
        longitude=coldest_days['Longitude'].mean(),
        zoom=11.5
    )
    ...
    html_file_path = 'coldest_days.html'
    deck.to_html(html_file_path)
    print("WE DONE BABAY")
    return
